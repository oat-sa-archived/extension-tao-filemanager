...
$testSuite = new TestSuite('TAO filemanager module unit tests');
...
$includePaths = array(ROOT_PATH.'filemanager/helpers');
$excludePaths = array();
$covReporter = new HtmlCoverageReporter("Code Coverage Report filemanager", "", PHPCOVERAGE_REPORTS."/filemanager");
